...
CREATE TABLE `customers_payment_summaries` (
  ...
  `selling_invoice_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `expenses` (
  ...
  `expense_description` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
(2, 2, '2023-02-20', 'January Shop Rant', 25000.00, 'Shop Rant', 'Active', 1, 1, NULL, '2023-02-20 06:02:36', '2023-03-06 04:31:03', NULL),
(3, 1, '2023-03-06', '2023 February Salary', 200000.00, '2023 February Salary', 'Active', 1, NULL, NULL, '2023-03-06 04:30:14', NULL, NULL);
...
(1, 'Salary', 'Active', 1, 1, NULL, '2023-02-20 06:01:50', '2023-03-06 04:20:16', NULL),
(2, 'Shop Rant', 'Active', 1, NULL, NULL, '2023-03-06 04:20:25', NULL, NULL);
...
CREATE TABLE `products` (
  ...
  `product_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default_product_photo.jpg',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `staff` (
  ...
  `staff_position` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `staff_nid_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(2, 1, '2023', 'February', 200000.00, '2023-03-06');
...
CREATE TABLE `suppliers` (
  ...
  `supplier_phone_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Super Admin', 'Sabbir Ahammed', 'superadmin@gmail.com', '01878136530', 'Male', '2023-03-06', 'Dhaka, Bd', 'default_profile_photo.png', 'Active', NULL, '2023-03-06 10:14:15', '$2y$10$LgNgJw99dWRsEUg4xq2hpek5ES19uX4cvp1C11G7Rq1bbAhjp6IEe', NULL, '2023-02-20 05:53:43', '2023-03-06 10:14:15'),

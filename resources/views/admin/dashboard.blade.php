        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <h3 class="card-title text-nowrap mb-1">{{ $customers->count() }}</h3>
            </div>
          </div>
        </div>
      </div>
            ...
            <li class="d-flex mb-4 pb-1">
              ...
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="user-progress">
                  <small class="fw-semibold">{{ $categories->count() }}</small>
                </div>
              </div>
            </li>
            <li class="d-flex mb-4 pb-1">
              ...
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="user-progress">
                  <small class="fw-semibold">{{ $brands->count() }}</small>
                </div>
              </div>
            </li>
            <li class="d-flex mb-4 pb-1">
              ...
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="user-progress">
                  <small class="fw-semibold">{{ $products->count() }}</small>
                </div>
              </div>
            </li>
          </ul>

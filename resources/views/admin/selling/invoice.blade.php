...
<head>
    ...
    <!-- Site Title -->
    <title>Selling Invoice = {{ $selling_summary->selling_invoice_no }}</title>
            ...
            <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb25">
                        <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Payment Status: </b>{{ $selling_summary->payment_status }}</div>
                        <div class="tm_invoice_info_list tm_white_color">
                            <p class="tm_invoice_number tm_m0">Invoice No: <b>#{{ $selling_summary->selling_invoice_no }}</b></p>
                            <p class="tm_invoice_date tm_m0">Date: <b>{{ $selling_summary->selling_date }}</b></p>
                        </div>
                    ...
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            ...
                            <p>
                                {{ $selling_summary->relationtocustomer->customer_name }}<br>
                                {{ $selling_summary->relationtocustomer->customer_address }}<br>
                                {{ $selling_summary->relationtocustomer->customer_phone_number }}<br>
                                {{ $selling_summary->relationtocustomer->customer_email }}
                            </p>
                        </div>
                    ...
                    <div class="tm_table tm_style1">
                                ...
                                <table class="tm_mb15">
                                    <tbody>
                                        <tr class="tm_gray_bg ">
                                            ...
                                            <td class="tm_width_3 tm_primary_color tm_bold tm_text_right">{{ $selling_summary->sub_total }}</td>
                                        </tr>
                                        <tr class="tm_gray_bg">
                                            <td class="tm_width_3 tm_primary_color">Discount<span class="tm_ternary_color"></span></td>
                                            <td class="tm_width_3 tm_primary_color tm_text_right">{{ $selling_summary->discount }}</td>
                                        </tr>
                                        <tr class="tm_accent_bg">
                        ...
                        @if ($selling_summary->payment_status != "Paid")
                        <div class="tm_invoice_footer tm_type1">
                            <div class="tm_left_footer"></div>
                            <div class="tm_right_footer">
                                <div class="tm_sign tm_text_center">
                                    <p class="tm_m0 tm_ternary_color tm_bold">Due Amount</p>
                                    <p class="tm_m0 tm_f16 tm_primary_color tm_bold">{{ $selling_summary->grand_total - $selling_summary->payment_amount }}</p>
                                </div>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="tm_note tm_text_center tm_font_style_normal">
                        ...
                        <p class="tm_m0">If you found any problem any product please contact next 24 hour.</p>
                    </div>
                </div>
            </div>

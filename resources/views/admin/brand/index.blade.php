        ...
        <div class="card">
                    ...
                    <div class="modal fade" id="trashedModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-primary" id="trashed_brand_table" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Sl No</th>
                                                <th>Brand Name</th>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-light" id="all_brand_table">
                        <thead>
                            <tr>
                                <th>Sl No</th>
                                <th>Brand Name</th>
...
<script>
    $(document).ready(function() {
        ...
        // Trashed Data
        trashed_table = $('#trashed_brand_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            ajax: {
                url: "{{ route('brand.trashed') }}",
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'brand_name', name: 'brand_name'},
